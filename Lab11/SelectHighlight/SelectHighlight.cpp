...
void SelectHighlight::onPluginLoad()
{
	// Load shaders
...
void SelectHighlight::preFrame()
{
	
}

void SelectHighlight::postFrame()
{
	GLWidget& g = *glwidget();
	Scene* sc = scene();

	int selected = sc->selectedObject();
	...
	Object &obj = sc->objects()[selected];
...
void SelectHighlight::onObjectAdd()
{
	
}

bool SelectHighlight::drawScene()
{
	return false; // return true only if implemented
}

bool SelectHighlight::drawObject(int)
{
	return false; // return true only if implemented
}

bool SelectHighlight::paintGL()
{
	return false; // return true only if implemented
}

void SelectHighlight::keyPressEvent(QKeyEvent *)
{
	
}

void SelectHighlight::mouseMoveEvent(QMouseEvent *)
{
